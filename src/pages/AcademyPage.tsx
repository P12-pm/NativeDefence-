...
import {
  ...
  GraduationCap, CheckCircle, Target, Trophy, Brain
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen transition-colors duration-500 text-white" style={{ background: '#0A0F1F' }}>
      ...
      <Navbar
        backLink="/"
        subLinks={[
          { label: 'About Academy', targetId: 'academy-intro' },
          { label: 'Mission & USP', targetId: 'mission-usp' },
          { label: 'Certification Courses', targetId: 'courses' },
        ]}
        ctaText="Enquire Now"
        ctaLink="/#contact"
      />
