...
import {
  ArrowRight, Lock, Key, MousePointerClick, Wifi, RefreshCw,
  FolderHeart, Sparkles, CheckCircle
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen transition-colors duration-500 text-white" style={{ background: '#0A0F1F' }}>
      ...
      <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-20 overflow-hidden">
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10">
          <div className="inline-flex items-center gap-2 bg-[rgba(0,229,255,0.08)] border border-[rgba(0,229,255,0.15)] rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-xs font-bold text-[#00E5FF] tracking-wider uppercase">End-User Security</span>
          </div>
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-[#00E5FF] font-medium">Safety Guidelines.</span>
            </h1>
            ...
            {safetyTips.map((tip) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-6 border-t border-[rgba(0,229,255,0.1)] mt-6 text-xs text-[#00E5FF] font-medium leading-relaxed bg-[rgba(0,229,255,0.08)]/50 dark:bg-[rgba(0,229,255,0.08)]/40 p-4 rounded-xl">
                    {tip.example}
                  </div>
                </div>
              );
      ...
      <section style={{ background: '#0A0F1F' }} className="py-16 transition-colors duration-500 border-t border-[rgba(0,229,255,0.1)]">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10">
          <div className="p-8 sm:p-12 rounded-3xl bg-[rgba(0,229,255,0.08)]  border border-[rgba(0,229,255,0.15)]  flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
